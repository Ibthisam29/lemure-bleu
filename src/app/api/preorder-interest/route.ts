  ...
  try {
    ...
    try {
      ...
      await resend.emails.send({
        ...
        to: email,
        subject: "Your Lemure Blue VIP Preorder Interest Has Been Received",
        html: `<div style="font-family:Georgia,serif;max-width:560px;margin:0 auto;padding:40px;background:#F8F3EA;"><h1 style="font-size:28px;font-weight:300;color:#151515;margin-bottom:16px;">Thank you, ${full_name}</h1><p style="color:#555;line-height:1.8;margin-bottom:16px;">Your preorder interest for the <strong>${tierLabels[preorder_tier]}</strong> has been received.</p><p style="color:#555;line-height:1.8;margin-bottom:24px;">Our concierge will contact you within 48 hours to confirm availability and provide payment details.</p><p style="color:#888;font-size:11px;margin-top:40px;border-top:1px solid #D8D2C8;padding-top:20px;">This registration does not guarantee financial return or gemstone appreciation.</p><p style="color:#888;font-size:12px;margin-top:12px;">Lemure Blue · Lemurebleu.com</p></div>`,
      });
      await resend.emails.send({
