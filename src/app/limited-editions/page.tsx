...
const SAMPLE: Partial<Collection>[] = [
  {
    id: "1",
...
export default async function LimitedEditionsPage() {
  ...
  const display = collections.length > 0 ? collections : SAMPLE;
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-12">
          <div className="space-y-8">
            {display.map((col, i) => (
              <div
                key={col.id}
                className="grid grid-cols-1 lg:grid-cols-5 overflow-hidden"
                style={{ border: "1px solid var(--stone)" }}
              >
                {/* Visual */}
                <div
                  className={`lg:col-span-2 h-64 lg:h-auto flex items-center justify-center ${i % 2 === 1 ? "lg:order-last" : ""}`}
                ...
                >
                  {col.image_url ? (
                    ...
                    <div className="text-center p-8">
                      <div
                        className="w-20 h-20 rotate-45 mx-auto mb-4"
                        style={{ background: "rgba(255,255,255,0.1)", border: "1px solid rgba(184,138,114,0.4)" }}
                      />
                      <p className="label-luxury" style={{ color: "rgba(184,138,114,0.7)" }}>
                ...
                <div className="lg:col-span-3 p-10 flex flex-col justify-center" style={{ background: "var(--ivory)" }}>
                  ...
                  <p className="text-sm leading-relaxed mb-6" style={{ color: "rgba(21,21,21,0.6)" }}>
                    {col.description}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-6 mb-8">
                    ...
                    {col.price_range && (
                      <div>
                        ...
                        <p className="text-sm mt-1 font-medium" style={{ color: "var(--charcoal)" }}>
                          {col.price_range}
                        </p>
                      </div>
                    )}
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <Link href="/appointment" className="btn-outline-dark">
